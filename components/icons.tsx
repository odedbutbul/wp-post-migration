...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M13.5 3.5C13.5 2.67 12.83 2 12 2S10.5 2.67 10.5 3.5V6H4.88C4.39 6 4 6.39 4 6.88V12H2V10.5C2 9.67 2.67 9 3.5 9H4V7.5C4 6.67 3.33 6 2.5 6S1 6.67 1 7.5V12C1 13.1 1.9 14 3 14H4V17.12C4 17.61 4.39 18 4.88 18H10.5V20.5C10.5 21.33 11.17 22 12 22S13.5 21.33 13.5 20.5V18H19.12C19.61 18 20 17.61 20 17.12V12H22V13.5C22 14.33 21.33 15 20.5 15S19 14.33 19 13.5V12C19 10.9 18.1 10 17 10H16V6.88C16 6.39 15.61 6 15.12 6H13.5V3.5ZM16 12V16H12V12H16ZM10 12V16H6V12H10ZM12 8H8V10H12V8ZM14 8V10H16V8H14Z" />
    </svg>
);
...
export const DisconnectIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="m14.25 10.5-4.5 4.5" />
    </svg>
);
...
export const MigrationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
